...
import { Text as TextNative, TextInput, View } from 'react-native';
...
>(({ className, nativeID: _nativeID, ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref as React.RefObject<TextNative>}
...
>(({ label, description, onChange, ...props }, ref) => {
  ...
  return (
    <FormItem>
      ...
      <Textarea
        ref={textareaRef as React.RefObject<TextInput>}
        aria-labelledby={formItemNativeID}
        aria-describedby={
          !error
            ? `${formDescriptionNativeID}`
...
>(({ label, description, value, onChange, ...props }, ref) => {
  ...
  return (
    <FormItem className='px-1'>
      <View className='flex-row gap-3 items-center'>
        <Switch
          ref={switchRef as React.RefObject<View>}
          aria-labelledby={formItemNativeID}
          aria-describedby={
            !error
              ? `${formDescriptionNativeID}`
